...
public interface TokenGenerator {
  ...
  /**
   * Generates an optionally human readable code which serves as a replacement for the URI (which is
   * usually presented to the user as a QR code).
   *
   * @param secretKey a shared secret.
  ...
  /**
   * Builds the handshake URI for a certain user using a pre-generated secret key and a descriptive
   * account name.
   *
   * <strong>Note:</strong> If the specialized generator implementation provides further properties,
   * default values are assumed for them unless specified with one of the overloads of this method.
   *
   ...
   * @throws UnsupportedOperationException when the generator requires additional parameters or the
   * Java VM implementation does not support the default encoding.
   */
  @NonNull
   ...
   *
   * @return a secret.
   * @throws UnsupportedOperationException when the current Java VM implementation does not support
   * the chosen hashing algorithm or HMAC itself.
   */
  @NonNull
  ...
  interface Builder {
    ...
    /**
     * Retrieves the currently configured hashing algorithm (defaults to {@link Algorithm#SHA1}).
     *
     * @return an algorithm.
     */
    @NonNull
     ...
     *
     * <strong>Note:</strong> This parameter is ignored by the Google Authenticator implementation
     * and should thus be left on its default value if compatibility with the Google implementation
     * is expected.
     *
    ...
    /**
     * Sets the period of time a key is valid for (only used when creating a TOTP based generator).
     *
     * <strong>Note:</strong> This parameter is ignored by the Google Authenticator implementation
     * and should thus be left on its default value if compatibility with the Google implementation
     * is expected.
